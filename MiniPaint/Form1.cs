            ...
            using (var a = e.Graphics)
            {
                foreach (var item in Figures)
                {
                    ...
                    else if (item is TriAngle triAngle)
                    {
                        ...
                        {
                            Point top = new Point(triAngle.Point.X + triAngle.Size.Width / 2, triAngle.Point.Y);
                            Point right = new Point(triAngle.Point.X + triAngle.Size.Width, triAngle.Point.Y + triAngle.Size.Height);
                            Point left = new Point(triAngle.Point.X, triAngle.Point.Y + triAngle.Size.Height);
